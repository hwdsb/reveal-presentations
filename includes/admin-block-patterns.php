...
register_block_pattern(
	...
	[
		...
		'content'     => '<!-- wp:media-text {"mediaType":"image","verticalAlignment":"top"} --><div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-top"><figure class="wp-block-media-text__media"><img src="https://hwdsbcommons.s3.amazonaws.com/wp-content/uploads/sites/65/2021/09/media-text-replace.png" /></figure><div class="wp-block-media-text__content"><!-- wp:heading {"level":3,"className":"has-text-align-center"} --><h3 class="has-text-align-center"></h3><!-- /wp:heading --></div></div><!-- /wp:media-text -->'
	]
);