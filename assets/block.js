...
function resize() {
  var element = document.querySelector('section.wp-block-slide-slide');
  if ( ! element ) {
  	return;
  }

  var parentWidth = element.parentNode.clientWidth;
  var scale = Math.min(1, parentWidth / 1010);
  var translate = scale === 1 ? "translate(0,0)" : "translate(-50%,-50%)"
  var transform = translate + " scale(" + scale + ")";
...
registerBlockType('slide/slide', {
  ...
  description: __( 'Create a slide for your presentation.'),
  icon: 'slides',
  category: 'common',
  ...
  edit: function edit(_ref) {
    ...
    e(PanelBody, {
      ...
      options: [{
        value: '',
        label: __('Use presentation default', 'slide'),
      }, {
        value: 'none',
        label: __('None', 'slide')
      }, {
      ...
      value: attributes.transition ? attributes.transition : '',
      onChange: function onChange(value) {
      	var value = '' !== value ? value : undefined;
        return setAttributes({
          transition: value
        });
      }
      ...
      value: attributes.backgroundTransition ? attributes.backgroundTransition : '',
      onChange: function onChange(value) {
      	var value = '' !== value ? value : undefined;
        return setAttributes({
      ...
      value: attributes.transitionSpeed ? attributes.transitionSpeed : '',
      onChange: function onChange(value) {
      	var value = '' !== value ? value : undefined;
        return setAttributes({
  ...
  save: function save(_ref3) {
    ...
    return e(attributes.hidden ? 'div' : 'section', {
      ...
      'data-background-transition': attributes.backgroundTransition ? attributes.backgroundTransition : undefined,
      'data-transition': attributes.transition ? attributes.transition : undefined,
      'data-transition-speed': attributes.transitionSpeed ? attributes.transitionSpeed : undefined
...
registerPlugin('slide', {
  render: function render() {
    ...
    var bodyRules = {
      'background-color': meta[bgColorKey] || 'transparent',
    ...
    })), [e('style', null, meta[cssKey]), !!meta[fontFamilyUrlKey] && e('style', null, "@import url(\"".concat(meta[fontFamilyUrlKey], "\")")), !!meta[fontFamilyHeadingKey] && e('style', null, (meta[fontFamilyHeadingUrlKey] ? "@import url(\"".concat(meta[fontFamilyHeadingUrlKey], "\");") : '') + ".wp-block-slide-slide h1, .wp-block-slide-slide h2, .wp-block-slide-slide h3, .wp-block-slide-slide h4, .wp-block-slide-slide h5, .wp-block-slide-slide h6 { font-family: ".concat(meta[fontFamilyHeadingKey], " }")), !!meta[fontWeightHeadingKey] && e('style', null, ".wp-block-slide-slide h1, .wp-block-slide-slide h2, .wp-block-slide-slide h3, .wp-block-slide-slide h4, .wp-block-slide-slide h5, .wp-block-slide-slide h6 { font-weight: ".concat(meta[fontWeightHeadingKey], " }")), e('style', null, ".editor-styles-wrapper .editor-writing-flow { width: ".concat(width, "px !important; }")),
